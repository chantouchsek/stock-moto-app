<template>
    <f7-page>
        <f7-navbar title="New Color" back-link="Back" sliding></f7-navbar>
        <f7-block-title>Add Color</f7-block-title>
        <f7-list no-hairlines-md form>
            ...
            <f7-block>
                <f7-row>
                    <f7-col>
                        <f7-button fill @click.native="createColor" big outline round>
...
<script>
  export default {
    ...
    methods: {
       ...
       * It'll dispatch the create action on the color module.
       */
      createColor () {
        const self = this
        self.$f7.preloader.show()
        self.$store.dispatch('color/create', self.form)
      },
