<template>
    <f7-page>
        ...
        <f7-block>
            ...
            <f7-row>
                <f7-col width="50" class="bg-color-white" @click.native="setLayoutTheme('light')"
                        style="cursor: pointer; padding: 30px; border: 1px solid rgba(0,0,0,0.1)"></f7-col>
                <f7-col width="50" class="bg-color-black" @click.native="setLayoutTheme('dark')"
                        style="cursor: pointer; padding: 30px; border: 1px solid rgba(255,255,255,0.1)"></f7-col>
            </f7-row>
        </f7-block>
        ...
        <f7-block>
            ...
            <f7-row>
                <f7-col width="33" v-for="color in colors" :key="color">
                    <f7-button style="margin-bottom:1em; text-transform: capitalize;" fill round raised :color="color"
