<template>
    <f7-page>
        ...
        <f7-block>
            <p>Framework7 comes with ready to use Login Screen layout. It could be used inside of page or inside of
                popup (Embedded) or as a standalone overlay:</p>
        </f7-block>
        ...
        <f7-login-screen class="demo-login-screen" :opened="loginScreenOpened"
            ...
            <f7-page login-screen>
                ...
                <f7-list>
                    ...
                    <f7-block-footer>Some text about login information.<br>Lorem ipsum dolor sit amet, consectetur
                        adipiscing elit.
                    </f7-block-footer>
                </f7-list>
            </f7-page>
